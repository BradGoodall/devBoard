...
function JobLane(props: Props) {
  ...
  if (isDragging) {
    return <div ref={setNodeRef} style={style} className="bg-columnBackgroundColor w-[350px] h-3/4 max-h-[800px] rounded-md flex flex-col opacity-60 border-2 border-indigo-500"></div>;
  }

  return (
    <div className="h-screen max-h-[75%]">
      <div ref={setNodeRef} style={style} className="opacity-95 bg-columnBackgroundColor w-[350px] h-3/4 rounded-md flex flex-col">
        {/* Lane Title */}
        <div
          {...attributes}
          {...listeners}
