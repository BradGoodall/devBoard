...
function JobCard({ job, deleteJob, updateJob, index }: Props) {
  ...
  return (
    ...
    >
      ...
      {mouseIsOver && (
        <button
          className=" stroke-white absolute right-2 top-2 bg-columnBackgroundColor p-2 rounded hover:stroke-rose-500"
          onClick={() => {
            deleteJob(job.jobID);
          }}
        >
